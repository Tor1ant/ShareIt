...
class BookingControllerTest {
    ...
    void addWithValidInputShouldReturnBooking() throws Exception {
        ...
        Mockito.when(bookingClient.createBooking(Mockito.any(BookingInputDto.class), Mockito.anyLong()))
        ...
        Mockito.verify(bookingClient).createBooking(Mockito.any(BookingInputDto.class), Mockito.anyLong());
    }
    ...
    void setApproveWithValidInputShouldReturnBooking() throws Exception {
        ...
        Mockito.when(bookingClient.setApproved(Mockito.anyLong(), Mockito.anyLong(), Mockito.anyBoolean()))
                .thenReturn(ResponseEntity.ok().body(expectedBooking));
        ...
        Mockito.verify(bookingClient).setApproved(Mockito.anyLong(), Mockito.anyLong(), Mockito.anyBoolean());
    }
    ...
    void getBookingWithValidInputShouldReturnBooking() throws Exception {
        ...
        Booking expectedBooking = new Booking();
        expectedBooking.setId(bookingId);
        Mockito.when(bookingClient.getBooking(Mockito.anyLong(), Mockito.anyLong())).thenReturn(ResponseEntity.ok()
    ...
    void getAllUserBookingsWithValidInputShouldReturnListOfBookings() throws Exception {
        ...
        Mockito.when(bookingClient.getAllBookings(Mockito.anyLong(), Mockito.anyString(), Mockito.anyLong(),
                        Mockito.anyLong()))
                .thenReturn(ResponseEntity.ok().body(expectedBookings));
    ...
    void getAllUserBookings_WithInvalidFromValue_ShouldReturnBadRequest() {
        ...
        Mockito.verify(bookingClient, Mockito.never()).getAllBookings(Mockito.anyLong(), Mockito.anyString(),
