...
class ItemRequestControllerTest {
    ...
    void postItemRequestTest() throws Exception {
        Mockito.when(itemRequestClient.postItemRequest(Mockito.any(), Mockito.any()))
    ...
    void getItemsRequest() throws Exception {
        Mockito.when(itemRequestClient.getItemRequests(Mockito.any()))
    ...
    void getItemsRequestInPagesTest() throws Exception {
        Mockito.when(itemRequestClient.getItemRequestsInPages(Mockito.any(), Mockito.anyLong(), Mockito.anyLong()))
                .thenReturn(ResponseEntity.ok(List.of(requestDtoWithItems)));
    ...
    void getItemRequestTest() throws Exception {
        Mockito.when(itemRequestClient.getItemRequest(Mockito.any(), Mockito.anyLong()))
