...
class ItemControllerTest {
    ...
    void setUp() {
        ...
        itemDtoWithBooking = new ItemDtoWithBooking("Тестовое дто", "тест", true);
    }

    @DisplayName("Тестирование получения предметов")
    @Test
    void getUserItemsTest() throws Exception {
        Mockito.when(itemService.getUserItems(Mockito.anyLong())).thenReturn(Collections
    ...
    void getItemTest() throws Exception {
        Mockito.when(itemService.getItem(Mockito.anyLong(), Mockito.anyLong())).thenReturn(itemDtoWithBooking);
    ...
    void addTest() throws Exception {
        ItemDTO itemDTO = new ItemDTO(null, "Тестовое название", "Тестовое описание", true,
                null);
        Mockito.when(itemService.addItem(Mockito.anyLong(), Mockito.any(ItemDTO.class))).thenReturn(itemDTO);
    ...
    void update() throws Exception {
        ...
        Mockito.when(itemService.update(Mockito.anyLong(), Mockito.any(ItemDTO.class))).thenReturn(itemDTO);
    ...
    void deleteItem() throws Exception {
        ...
        Mockito.verify(itemService, Mockito.times(1)).deleteItem(Mockito.anyLong(),
                Mockito.anyLong());
    }
    ...
    void createComment() throws Exception {
        ...
        Mockito.when(itemService.createComment(userId, itemId, inputCommentDto)).thenReturn(commentDto);
        ...
        Mockito.verify(itemService, Mockito.times(1)).createComment(userId, itemId, inputCommentDto);
    }
}